...
require_once '../authentication-sdk/core/MerchantConfiguration.php';
class TestConfiguration
{
    ...
    function __construct()
    {
            ...
            $this->logFile = "../../Cybersourceauthentication-sdkPhp/Log/";
            ...
            $this->keyDirectory = "../../Cybersourceauthentication-sdkPhp/resource/";
